...
export const STRINGS: Record<Lang, Strings> = {
  en: {
    mainMenu: [
      ...
      },
      {
        ...
        children: [
          ...
          { href: "/support-services/", label: "Support beyond ABA", note: "Referrals, IEPs, paperwork" },
      ...
      },
      {
        ...
        children: [
          ...
          { href: "/events/", label: "Sensory-friendly events", note: "Come as you are" },
        ],
      },
      {
        href: "/careers/",
    ...
    autismQuestionHref: "/find-a-diagnostician/",
    menuOpen: "Open menu",
